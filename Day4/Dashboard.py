...
@st.cache_data
def load_data():
    df_agg = pd.read_csv('Day4/Aggregated_Metrics_By_Video.csv', encoding='utf-8').iloc[1:,:]
    ...
    df_agg_sub = pd.read_csv('Day4/Aggregated_Metrics_By_Country_And_Subscriber_Status.csv')
    df_comments = pd.read_csv('Day4/Aggregated_Metrics_By_Video.csv')
    df_time = pd.read_csv('Day4/Video_Performance_Over_Time.csv')
...
if add_sidebar == 'Individual Video Analysis':
    video_select = st.selectbox('Pick A Video', ('Video 1', 'Video 2'))
